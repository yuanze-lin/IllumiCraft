...
class WanTransformer3DModelTracking(WanTransformer3DModel, ModelMixin):
    ...
    def __init__(
        ...
        **kwargs
        ...
        print('Lighting Token Number: ', self.light_token_num)
    ...
    def forward(
        ...
        default = self.hdr_default_tokens.expand(x.shape[0], -1, -1)  # [B,3,inner_dim]
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        # kwargs2 = {}
        # kwargs2['subfolder'] = kwargs['subfolder']
        # kwargs2['torch_dtype'] = kwargs['torch_dtype']
        try:
