...
from . import (AutoencoderKLWan, AutoTokenizer, CLIPModel,
...
class WanFunControlPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.image_processor = VaeImageProcessor(vae_scale_factor=self.vae.spacial_compression_ratio, do_normalize=False, do_resize=False)
    ...
    def prepare_control_latents(
            self, control, control_image, batch_size, height, width, dtype, device, generator,
