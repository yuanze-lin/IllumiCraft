...
def _get_dataset_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="video",
        help="The column of the dataset containing foreground videos. Or, the name of the file in `--data_root` folder containing the line-separated path to video data.",
    )
    parser.add_argument(
        "--caption_column",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The column of the dataset containing the background map for each video. Or, the name of the file in `--data_root` folder containing the line-separated tracking maps.",
    )
    parser.add_argument(
        "--tracking_map_path",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the hdr map video.",
    )
    parser.add_argument(
        "--foreground_map_path",
        type=str,
        default=None,
        help="Path to the foreground map video.",
    )
    parser.add_argument(
        "--num_tracking_blocks",
        type=int,
